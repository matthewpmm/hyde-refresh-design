...
- Tarot Table SOLVED, steam valve NOT TURNED
	1. "You've found the broken valve handle! There is an opening in the wall near the brake lever - insert the valve and turn it!"
- [[Puzzles/Puzzle 2 - Steam Whistles]]
	1. "You have restored the flow of steam to the whistles! Now you must find the correct order in which to pull them."
	2. "Remember, travelers, that the *ticket* to success on a journey is to never forget your *map*."
	3. "Travelers, look at the back side of your ticket. Is there anywhere you can place it where all the punched holes are filled by symbols?"
...
- [[Puzzles/Puzzle 3 - The Gas Pump]]
	- Before the pump is activated:
		1. (if not yet activated) "Travelers, beneath me there is a device that can pump fuel. Insert a gasoline canister into it cap-first to activate it."
	- When the pump has been activated but the Pickled Punks have not been:
		1. "Rotate the valves on the wall to change the direction in which the gas flows. The gas must flow to an exhibit to activate it."
...
> "Travelers, hurry! Only 30 minutes remain before your time runs out."
