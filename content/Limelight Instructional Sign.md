...
A metal sign affixed to the [[Lighting/Limelight]]'s [[Creative Technology/Gas Lantern]] chamber door to instruct players on how to interact with the puzzle.
# Deliverables
...
- Must convey the following using pictographs/illustrations:
	- The gas lantern is a specific handheld device.
	- This sign is on a door that can be opened, and the lantern can be placed inside.
