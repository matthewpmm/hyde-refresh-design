...
modified: 2026-02-05T14:30:16.675-08:00
cssclasses: ""
---
...
# Backstory
After being briefed on gameplay rules, players learn that they have received a mysterious letter addressed to them personally as “(booking name) and guests,” which they are handed by the game master.
...
> _Dearest guests,_
> 
> _I hereby extend a most cordial invitation to the grand reopening of Hyde Circus, the oldest and most fantastic amusement venue in the world. I have been hard at work acquiring many new attractions with which to pique your curiosity and cannot wait to share my discoveries!_
> 
> _Please make your way to the end of the hallway, where you will find a large wooden train car. This is the Hyde Circus Express. Please board it and pull the lever to begin your journey._
> 
> _I simply cannot wait to dazzle and amaze you._
> 
> *-- The Esteemed Ringmaster of Hyde Circus*

Guests may now make their way down the hallway to board the train.
# Train Car (Passenger Rooms)
Upon boarding the train car, guests find that the left side of the hallway contains a locked **Engine Room**, while the right side is accessible. This room contains a locked safe, a **gas** canister, a train **gas pump**, a series of **gas pipes** and **valves**, as well as two levers: a **start lever** and a **brake lever** locked with a rusty chain. After the train door shuts behind them, guests pull the start lever to start the train. The train shudders and shakes as the engine sputters to life and the train begins moving.
...
Suddenly, a gravelly voice (**The Contortionist**) begins to speak from a pipe in the wall.
...
Most of these labeled sections have a slot into which a knife can be placed. Players must determine which four of these constellations refer to things found around the room with knives sticking out of them and plunge the knives into the corresponding slots. The correct constellations are:

- **The Specimen**, corresponding to the Pickled Punk jar with a knife plunged into it.
- **The Acrobat**, corresponding to the acrobat suspended from the ceiling, who is clearly seen to have a knife in his body when the limelight is pointed at him.
- **The Crescent Moon**, corresponding to the illuminated moon hanging from the ceiling, which from certain angles can be seen to have a knife stuck into it.
...
## Puzzle 7: The Mirror Maze Lock
Now that all the gas tanks have been acquired, if all available tanks are connected to the gas pump, it becomes possible for the flame to reach the mirror maze lock. However, players must first route the flame through the most challenging series of junctions yet, stretching all the way around the courtyard and slowly illuminating the entire space.

Once the flame reaches the lock, a mechanical device is powered, and with a deep groan, the door to the big top finally opens, and players can enter the Hall of Mirrors.
# Hall of Mirrors
Players venture into a hallway full of funhouse mirrors with a checkered floor. Mounted on the wall are **six large wheels** arranged in a triangular shape.
## Puzzle 8: Pyramid of Wheels
Inside the Big Top is a pyramid of six close-together rotating wheels with branching paths carved into them. The label on top of the pyramid reads _“There are no dead ends.”_ Players must rotate the wheels by hand until there are no dead ends remaining, and all paths connect to another path carved into an adjacent wheel.
...
## Puzzle 9: Infinite Wandering Eyes (Pyramid of Wheels Pt. 2)
