...
Inside the Ringmaster's Journal Entry is a puzzle box.

To correctly open the puzzle box, it must be placed on the ground and spun quickly. This causes centrifugal force to pull out all the metal pins holding the lid in place, allowing it to be lifted out.

Players must open the puzzle box found inside the Ringmaster's 
