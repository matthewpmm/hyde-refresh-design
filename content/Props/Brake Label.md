...
- At the bottom of the sign, there must be a clearly visible downward-pointing arrow indicating that the brake lever is below the sign.
...
- All design files should meet the following specifications:
	- Color format: CMYK
	- 300dpi
	- Dimensions: no less than 12" wide and 6" in height.
